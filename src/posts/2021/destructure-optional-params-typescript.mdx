...
However you'll get an error becuase param could be undefined and TS doesn't like
you trying to destructure something that's undefined. There are a couple ways
around this...
