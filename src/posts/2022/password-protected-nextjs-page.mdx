...
This is NOT the most secure setup in the world, although the logic behind
`iron-session` and encrypted cookies is great, but this will provide you with a
very functional basic password protected route with Next.JS.
